 ...
 * @file
 *
 * BPACC_FUN Application Platform Configuration Header File
 *
 ...
 * dictionary tool.
 */
#ifndef BPACC_FUN_PLATFORM_CFG_H
#define BPACC_FUN_PLATFORM_CFG_H

#include "bpacc_fun_mission_cfg.h"
#include "bpacc_fun_internal_cfg.h"
