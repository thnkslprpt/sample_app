...
void Test_BPACC_FUN_APP_Main(void)
{
    CFE_SB_MsgId_t MsgId = CFE_SB_INVALID_MSG_ID;

    /*
     * Test Case For:
     * void BPACC_FUN_APP_Main( void )
     */

    UT_CheckEvent_t EventTest;

    /*
     * BPACC_FUN_APP_Main does not return a value,
     ...
     * The first is for BPACC_FUN_APP_Init().  As this is in the same
     ...
     * the BPACC_FUN_APP_Init() failure path was taken.
     */
    BPACC_FUN_APP_Main();
     ...
     */
    UtAssert_UINT32_EQ(BPACC_FUN_APP_Data.RunStatus, CFE_ES_RunStatus_APP_ERROR);
    ...
    UT_CHECKEVENT_SETUP(&EventTest, BPACC_FUN_APP_PIPE_ERR_EID, "BPACC_FUN APP: SB Pipe Read Error, App Will Exit");
...
void Test_BPACC_FUN_APP_Init(void)
{
    /*
     * Test Case For:
     * CFE_Status_t BPACC_FUN_APP_Init( void )
     */

    /* nominal case should return CFE_SUCCESS */
    UtAssert_INT32_EQ(BPACC_FUN_APP_Init(), CFE_SUCCESS);
     ...
     */
    UT_SetDeferredRetcode(UT_KEY(CFE_EVS_Register), 1, CFE_EVS_INVALID_PARAMETER);
    UtAssert_INT32_EQ(BPACC_FUN_APP_Init(), CFE_EVS_INVALID_PARAMETER);
    UtAssert_STUB_COUNT(CFE_ES_WriteToSysLog, 1);

    UT_SetDeferredRetcode(UT_KEY(CFE_SB_CreatePipe), 1, CFE_SB_BAD_ARGUMENT);
    UtAssert_INT32_EQ(BPACC_FUN_APP_Init(), CFE_SB_BAD_ARGUMENT);
    ...
    UtAssert_INT32_EQ(BPACC_FUN_APP_Init(), CFE_TBL_ERR_INVALID_OPTIONS);
...
{
    ADD_TEST(BPACC_FUN_APP_Main);
    ADD_TEST(BPACC_FUN_APP_Init);
}
